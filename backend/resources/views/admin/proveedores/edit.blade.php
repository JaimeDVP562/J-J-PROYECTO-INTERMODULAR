...
<div class="card border-0 shadow-sm">
    <div class="card-header bg-white border-0 fw-semibold py-3">
        <i class="bi bi-pencil me-2 text-secondary"></i>Editar proveedor #{{ $proveedor->id }}
    </div>
    <div class="card-body">
        @if ($errors->any())
        ...
        <form method="POST" action="{{ route('admin.proveedores.update', $proveedor->id) }}">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="email" name="contact_email" class="form-control" value="{{ old('contact_email', $proveedor->contact_email) }}">
                </div>
                <div class="col-md-6">
                    <label class="form-label fw-semibold">Teléfono</label>
                    <input type="text" name="phone" class="form-control" value="{{ old('phone', $proveedor->phone) }}">
                </div>
                <div class="col-md-6">
                    <label class="form-label fw-semibold">Dirección</label>
                    <input type="text" name="address" class="form-control" value="{{ old('address', $proveedor->address) }}">
                </div>
            </div>
